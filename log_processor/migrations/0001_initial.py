# Generated by Django 3.2 on 2024-07-16 04:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meter_value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sampled_values', to='log_processor.metervalue')),
            ],
        ),
        migrations.AddField(
            model_name='metervalue',
            name='operation',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='meter_value', to='log_processor.metervaluesrequest'),
        ),
    ]
